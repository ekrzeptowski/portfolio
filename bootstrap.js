...
const questions = [
  ...
  {
    name: "matomo",
    when: !argv.matomo && !process.env.MATOMO_URL,
    message: "Do you want to enable matomo analytics?",
    type: "confirm",
    default: false,
  },
  {
  ...
  .then(({ spaceId, managementToken, accessToken, matomoURL, siteId }) => {
    ...
    const fileContents =
      [
        ...
        matomoURL ? `MATOMO_URL='${matomoURL}'` : "",
